...
class HtAppRegisterKeypairDialog extends Polymer.TkLocalizerMixin(Polymer.mixinBehaviors([], Polymer.Element)) {
  static get template() {
    return Polymer.html`
        <style>
        </style>
...
`;
  ...
  selectFile() {
    ...
    this.fire('file-selected', this.selectedRsaFile)
  }
