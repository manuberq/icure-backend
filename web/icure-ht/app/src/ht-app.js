...
import './elements/icc-x-api/icc-x-api.js';
...
class HtApp extends Polymer.TkLocalizerMixin(Polymer.Element) {
  static get template() {
    return Polymer.html`
        ...
        <icc-x-api id="api" host="/rest/v1" fhc-host="http://127.0.0.1:8090" headers="[[headers]]" credentials="[[credentials]]"></icc-x-api>

        <!-- <paper-item id="noehealth" class="notification-panel noehealth">No Ehealth connection
        ...
        <ht-my-profile id="ht-my-profile" i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" api="[[api]]" user="[[user]]"></ht-my-profile>
        ...
        <app-drawer-layout fullbleed="">
            ...
            <app-header-layout fullbleed="">
                        ...
                        <div class="log-info">
                            ...
                            <paper-tooltip for="ehealth">
                                <template is="dom-if" if="[[api.tokenId]]">
                                    eHealth is connected
                                </template>
                                <template is="dom-if" if="[[!api.tokenId]]">
                                    eHealth is not connected
                                </template>
                            </paper-tooltip>
                        </div>
                        <div>
                            ...
                            <paper-menu-button horizontal-align="right" close-on-activate="" no-overlap="" no-animations="" focused="false">
                                ...
                                <paper-listbox class="extra-menu" slot="dropdown-content" stop-keyboard-event-propagation="">
                                    ...
                                    <paper-item class="extra-menu-item" on-tap="_myProfile">[[localize('my_pro','My profile',language)]]</paper-item>
                                </paper-listbox>
                            </paper-menu-button>
                        </div>
                    </app-toolbar>
                ...
                <iron-pages selected="[[view]]" attr-for-selected="name" fallback-selection="view404" role="main">
                    <ht-main name="main" api="[[api]]" user="[[user]]">
                        <splash-screen></splash-screen>
                    </ht-main>
                    <ht-pat name="pat" api="[[api]]" i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" attachedlanguageressources="attachedLanguageRessources" user="[[user]]" route="{{subroute}}">
                        <splash-screen></splash-screen>
                    </ht-pat>
                    <ht-hcp name="hcp" api="[[api]]" i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" attachedlanguageressources="attachedLanguageRessources" user="[[user]]">
                        <splash-screen></splash-screen>
                    </ht-hcp>
                    <ht-msg name="msg" api="[[api]]" i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" attachedlanguageressources="attachedLanguageRessources" host="/rest/v1" headers="[[headers]]">
                        <splash-screen></splash-screen>
                    </ht-msg>
  ...
  static get properties() {
    return {
      ...
      lazyPages: {
        ...
        value: {
          main() {
            null//import(/* webpackChunkName: "ht-main" */ './ht-main.html')
          },
          pat() {
            null//import(/* webpackChunkName: "ht-pat" */ './ht-pat.html')
          },
          hcp() {
            null//import(/* webpackChunkName: "ht-hcp" */ './ht-hcp.html')
          },
          msg() {
            null//import(/* webpackChunkName: "ht-msg" */ './ht-msg.html')
          },
          view404() {
            null//import(/* webpackChunkName: "ht-view404" */ './ht-view404.html')
          }
        }
      },
      resources: {
